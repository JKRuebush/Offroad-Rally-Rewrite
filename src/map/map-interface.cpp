...
std::vector<std::pair<Point, Direction::T>> MapInterface::getNeighbors(
    Point pos) const {
...
uint MapInterface::getMoveCost(Point pos, Direction::T dir) {
  mapLooks += 1;
...
// is returned.
Point MapInterface::getDestination(Point pos, Direction::T dir) const {
