...
// StarM keeps track of roughness values. Knowing that the start always has a
// roughness of one, it can work out the roughness values. Once it has the
// underlying value it no longer has to look at the map.
REGISTER_AGENT(AStarM)(MapInterface* const api) {
